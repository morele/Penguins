...
namespace TestGame
{
    ...
    public class Game1 : Game
    {
        ...
        private Rico _rico;
        private KeyboardState _keyCurrentState;
        private KeyboardState _keyOldState;
        public Game1()
        {
        ...
        protected override void LoadContent()
        {
            ...
            _rico = new Rico(spriteBatch, Content,graphics);
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            {
                _rico.UpdatePositionLeft();
            }
            if (_keyCurrentState.IsKeyDown(Keys.Right))
            {
                _rico.UpdatePositionRight();
            }
